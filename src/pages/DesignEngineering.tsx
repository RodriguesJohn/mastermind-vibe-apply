...
const DesignEngineering = () => {
  const modules = [{
    ...
    logos: ["https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg", "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/css3/css3-plain.svg"],
    status: "available"
  }, {
    number: "4",
          ...
          <section className="relative py-16 md:py-24 overflow-hidden bg-black text-white border-b border-white/10">
            ...
            <div className="px-4 md:px-10 lg:px-[120px] relative z-10 w-full">
              <div className="max-w-[1200px] mx-auto">
                ...
                <h1 className="font-medium mb-4 tracking-tight text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Become a Design 
Engineer 
in 90 day                                              <br /> Design Engineer
                </h1>
            ...
            <div className="px-4 md:px-10 lg:px-[120px]">
              <div className="max-w-[1200px] mx-auto">
                <div className="text-center mb-16 space-y-4">
                  <h2 className="font-medium tracking-tight" style={{
                  fontSize: '32px',
                  lineHeight: '1.25'
                }}>
                    What You'll Get
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  {benefits.map((benefit, index) => <Card key={index} className="p-8 bg-white/5 border-white/10 hover:border-primary/50 transition-all overflow-hidden group">
              ...
              <div className="max-w-[1200px] mx-auto grid md:grid-cols-3 gap-8">
                ...
                delay: 0.1
                  ...
                  <div className="relative bg-gradient-to-br from-yellow-50 to-yellow-100 p-8 md:p-12 rounded-lg shadow-2xl border-2 border-yellow-200/50 transform rotate-[1deg]">
                    ...
                    <p className="text-gray-800 text-lg md:text-xl leading-relaxed" style={{
          ...
          <section className="py-24 md:py-32 bg-black text-white overflow-hidden border-b border-white/10">
            <div className="px-4 sm:px-8 md:px-10 lg:px-[120px]">
              <div className="max-w-[1200px] mx-auto">
                <h2 className="font-medium text-center mb-16 tracking-tight" style={{
                fontSize: '32px',
                lineHeight: '1.25'
              }}>
                  Curriculum Overview
                  ...
                  <div className="grid items-start gap-12 divide-y divide-white/10 p-8 md:p-12 md:grid-cols-2 md:divide-x md:divide-y-0">
                    ...
                    <div className="relative pt-0 md:pt-4 md:pl-12">
                      <ul role="list" className="space-y-4">
                        {['Start your Design Engineering Journey today', 'Get access to hands-on practical courses all in one place with structured learning', 'Private community of design engineers', 'Self-paced learning', 'Gamified learning experience with leaderboard'].map((item, index) => <li key={index} className="flex items-start gap-3">
                            <Check className="text-primary size-4 flex-shrink-0 mt-0.5" strokeWidth={3.5} />
