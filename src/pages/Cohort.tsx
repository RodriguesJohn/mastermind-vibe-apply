  ...
  const customerTestimonials = [
    {
      ...
      description: "Learn how AI products are designed for Variables. Create human-centered AI variables and make AI more human-centric.",
      imageSrc:
    ...
    },
    {
      id: 2,
      quote:
        "John's strategic frameworks and demos helped me think like a strategist and a solutionist.",
      name: "Seth Jenks",
