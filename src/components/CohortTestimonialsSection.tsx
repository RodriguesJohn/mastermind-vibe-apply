...
interface CohortTestimonialsSectionProps {
  title?: string;
}

export const CohortTestimonialsSection = ({ title = "What Cohort Members Are Saying" }: CohortTestimonialsSectionProps) => {
      ...
      <div className="px-4 sm:px-6 md:px-10 lg:px-[120px]">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0 mb-6 sm:mb-8">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-normal">{title}</h2>
            <button
