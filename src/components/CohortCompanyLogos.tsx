    ...
    <section className="py-16 bg-black text-white border-b border-white/10">
      <div className="px-4 md:px-10 lg:px-[120px]">
        <div className="max-w-[1200px] mx-auto">
          <h2 className="text-left text-sm font-medium text-white/30">
            Our Mentors, designers and community members come from
          </h2>
          <div className="mt-16 grid grid-cols-3 md:flex md:flex-wrap items-center justify-start gap-x-4 gap-y-6 md:gap-x-12 md:gap-y-8 sm:gap-x-16 sm:gap-y-12">
